...
public extension AddonRuntime {
    /// Installs an extension shipped inside the application bundle. Built-in
    /// extensions are the GeckoView-supported way to grant native-messaging
    /// privileges without requiring a signed AMO package.
    func ensureBuiltIn(location: String, id: String) async throws {
